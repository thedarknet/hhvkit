...
#define REPORT_BUFFER_SIZE 4
  uchar    reportBuffer[REPORT_BUFFER_SIZE];    // buffer for HID reports [ 1 modifier byte + (len-1) key strokes]

};

// Moved to initalize in the main loop.
...
//uchar usbFunctionSetup(uchar data[8], usbMsgPtr_t reportBuffer) 
uchar usbFunctionSetup(uchar data[8]) 
  {
    usbRequest_t    *rq = (usbRequest_t *)((void *)data);

    //memcpy (usbMsgPtr, reportBuffer, REPORT_BUFFER_SIZE); //
